...
import { bearingToXY, clamp, distancePointToSegment, hdgVector, headingToPoint } from "./geometry.js";
import { isAlternateMode, isApproachMode } from "./arrivalApproach.js";
import { MISSION_AREAS, missionAreaPoint } from "./military.js";
...
export function nearestMissionAreaAhead(ac, heading) {
